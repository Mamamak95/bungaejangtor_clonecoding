      ...
      (
        <>
          <header>{/* 헤더 전체를 덮는 태그 */}
                      ...
                      <div className="mystorelist" ref={mystorePopup}>
                        <ul>
                          <li onMouseEnter={handleStoreListEnter} onMouseLeave={handleStoreListLeave}>
                            <Link to = '/product'>내 상품</Link>
                          </li>
                          <li onMouseEnter={handleStoreListEnter} onMouseLeave={handleStoreListLeave}>
                            <Link to = '/product'>찜한상품</Link>
                          </li>
                          <li onMouseEnter={handleStoreListEnter} onMouseLeave={handleStoreListLeave}>
                            <Link to = '/'>계정설정</Link>
                          </li>
            ...
            <div className="HeaderMain">
              <div className="headerMainWrap inner">
                <div className="HeaderContents">{/* 헤더메인부분의 모든 콘텐츠를 감싸는 태그 */}
                  ...
                  <form className="HeaderSearch" onFocus={() => {handleFocusSearch(true)}} onBlur={() => {handleFocusSearch(false)}}>{/* 헤더메인부분의 검색창을 다루는 컴포넌트 */}
                ...
                <div className="HeaderCategory">{/* 헤더메인부분의 맨 아래쪽 카테고리를 감싸는 태그 */}
                  <i class="fa-solid fa-bars categoryMenu"></i>
            ...
            { SearchToggle && <HeaderSearch handleFocusSearch={handleFocusSearch}/> }
          </header>
        </>
      )
      :
