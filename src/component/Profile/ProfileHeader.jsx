    ...
    <div className="inner">
      <div className="pro_header">
        ...
        <div className="left_box">
          ...
          <p className="stor">상점 82307748 호</p>
          ...
          <button className="stor_but">내 상점 관리</button>
        </div>
        ...
        <div className="right_box">
          ...
          <div className="first">
            <div className="float_left">
              <p className="inline stor">상점 82307748 호</p>
          ...
          <div className="second">
              <div className="smallfont">
                ...
                <p className="inline ">상점오프일 13일전</p>
              </div>
              <div className="smallfont">
                <p className="inline float_left"><RiStoreLine/></p>
          ...
          <div className="third">
            <button className="sbox float_left">소개글 수정</button>
          </div>
