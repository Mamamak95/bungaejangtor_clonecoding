      ...
      <div className="downloadqr">
        <div className="downloadqrwrap">
          <div className="closeBtn">
            <button type="button" onClick={()=> prop.qrToggleBtn(false)}><img src="http://192.168.50.57:8000/webImg/closebtn.png" alt="closeBtnImg" /></button>
          </div>
          <div className="downloadContent">
            <div className="downloadtitle">
              <img src="http://192.168.50.57:8000/webImg//downqr.png"/>
            ...
            <div className="downloadqrImg">
              <img src="http://192.168.50.57:8000/webImg//qrcode.png" alt="qrImg" />
            </div>
          </div>
        </div>
      </div>
